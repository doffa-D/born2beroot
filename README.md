...
GRANT ALL PRIVILEGES ON bonus.* to 'hdagdagu'@'localhost' IDENTIFIED BY '0000';
...
```
define( 'DB_NAME', 'bonus' );^M
define( 'DB_USER', 'hdagdagu' );^M
define( 'DB_PASSWORD', '0000' );^M
```
...
<!--
- Wordpress login: `hdagdagu`
- pass: `8pDLO&%0va1uSx63gV`
-->
